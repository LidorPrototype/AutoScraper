...
sys.path.append('./logic_functions/auto_scraping')
...
class Auto_Scraper(object):
    ...
    def save(self, file_path):
        """
            ...
            Parameters:
                :param file_path: Path of the JSON output
                :type file_path: str
        """
    ...
    def load(self, file_path):
        """
            ...
            Parameters:
                :param file_path: Path of the JSON file to load stack_list from.
                :type file_path: str
        """
    ...
    def build_model(
        ...
        """
            ...
            Parameters:
                ...
                :param wanted_list: list of strings or compiled regular expressions, optional
                                    A list of needed contents to be scraped.
                                        AutoScraper learns a set of rules to scrape these targets. 
                                        If specified, wanted_dict will be ignored.
                :param wanted_dict: dict, optional
                ...
                :param update: bool, optional, defaults to False
                                If True, new learned rules will be added to the previous ones.
                                If False, all previously learned rules will be removed.
                :param text_fuzz_ratio: float in range [0, 1], optional, defaults to 1.0
                                        The fuzziness ratio threshold for matching the wanted contents.
                :param remove_duplicates: boolean flag indicates if we need to remove duplicates or not,
                                          defaults to True
            Returns:
                :return result_list: List of similar results
        """
...
#             pass # Handle it outside this code for now
#             result_list = unique_hashable(result_list) # DUPLICATE RELATED
#             self.stack_list = unique_stack_list(self.stack_list) # DUPLICATE RELATED
        ...
        """
            ...
            Parameters:
                ...
                :param html: str, optional
                             ...
                             You should either pass url or html or both.
                :param request_args: dict, optional
                                     A dictionary used to specify a set of additional request parameters used by 
                                     requests module. You can specify proxy URLs, custom headers etc.
                :param grouped: bool, optional, defaults to False
                                If set to True, the result will be a dictionary with the rule_ids as keys
                                and a list of scraped data per rule as values.
                :param group_by_alias: bool, optional, defaults to False
                                       If set to True, the result will be a dictionary with the rule alias as keys
                                       and a list of scraped data per alias as values.
                :param unique: bool, optional, defaults to True for non grouped results and
                               False for grouped results.
                               If set to True, will remove duplicates from returned result list.
                :param attr_fuzz_ratio: float in range [0, 1], optional, defaults to 1.0
                                        The fuzziness ratio threshold for matching html tag attributes.
                :param keep_order: bool, optional, defaults to False
                                   If set to True, the results will be ordered as they are present on the web page.
                :param contain_sibling_leaves: bool, optional, defaults to False
                                               If set to True, the results will also contain the sibling 
                                               leaves of the wanted elements.
            Returns:
        ...
        """
            ...
            Parameters:
                ...
                :param html: str, optional
                             ...
                             You should either pass url or html or both.
                :param request_args: dict, optional
                                     A dictionary used to specify a set of additional request parameters 
                                     used by requests module. You can specify proxy URLs, custom headers etc.
                :param grouped: bool, optional, defaults to False
                                If set to True, the result will be a dictionary with the rule_ids as keys
                                and a list of scraped data per rule as values.
                :param group_by_alias: bool, optional, defaults to False
                                       If set to True, the result will be a dictionary with the rule alias 
                                       as keys and a list of scraped data per alias as values.
                :param unique: bool, optional, defaults to True for non grouped results and
                               False for grouped results.
                               If set to True, will remove duplicates from returned result list.
                :param attr_fuzz_ratio: float in range [0, 1], optional, defaults to 1.0
    ...
    def remove_rules(self, rules):
        """
            ...
            Parameters:
                :param rules: A list of rules to be removed
                :type tules: list
        """
    ...
    def keep_rules(self, rules):
        """
            ...
            Parameters:
                :param rules: A list of rules to keep in stack_list and removing the rest.
                :type rules: list
        """
    ...
    def set_rule_aliases(self, rule_aliases):
        """
            ...
            Parameters:
                :param rule_aliases : A dictionary with keys of rule_id and values of alias
                :type rule_aliases: dict
        """
