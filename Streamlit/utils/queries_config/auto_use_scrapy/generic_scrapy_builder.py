...
def gs_builder(path_vir_env=None, project=None, out=None, src_tmplt=None, urls=[], prefixes=[""],metadata={"names": [""], "values": [""]}, queries={"names": [""], "xpaths": [""]}):
    ...
    _path_to_virtual_env = f'cd {path_vir_env}' or 'cd C:\\Users\\t22q\\demo\\AutoScraperSpiders' # cd../demo
    _project = project or default_project_name           # Get from user
    _output = out or f'{default_project_name}.csv'       # Get from user
    _scrap_name = 'tmplt'
    _source_template = src_tmplt or 'C:\\Users\\t22q\\Desktop\\DSG\\AutoScraper\\utils\\queries_config\\auto_use_scrapy\\tmplt.py'
    _spider_dest = f'C:\\Users\\t22q\\demo\\AutoScraperSpiders\\{_project}\\{_project}\\spiders'
    _path_to_spider_folder = f'C:\\Users\\t22q\\demo\\AutoScraperSpiders\\{_project}'
    _path_to_csvs_folder = f'C:\\Users\\t22q\\demo\\AutoScraperSpiders\\{_project}\\csvs'
